...
namespace ContosoUniversity.Migrations
{
    ...
    [Migration("20170207192219_commentDate")]
            ...
            modelBuilder.Entity("ContosoUniversity.Models.DatesSuggestion", b =>
                {
                    ...
                    b.Property<int?>("MeetingCommitteeID");

                    b.Property<int?>("MeetingID1");

                    b.HasKey("MeetingID", "ProfessorID");

                    b.HasIndex("ProfessorID");

                    b.HasIndex("MeetingID1", "MeetingCommitteeID");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.DatesSuggestion", b =>
                {
                    ...
                    b.HasOne("ContosoUniversity.Models.Meetings", "Meeting")
                        ...
                        .HasForeignKey("MeetingID1", "MeetingCommitteeID");
                });
